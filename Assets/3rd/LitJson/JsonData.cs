...
namespace LitJson
{
    public class JsonData : IJsonWrapper, IEquatable<JsonData>
    {
        ...
        #region Properties
        static public JsonData ToJsonObject(string json)
        {
            return JsonMapper.ToObject<JsonData>(json);
        }

        static public JsonData ToJsonObject(byte[] buffer)
        {
            string json = (buffer != null) ? Encoding.UTF8.GetString(buffer) : "{}";
            return JsonMapper.ToObject<JsonData>(json);
        }
